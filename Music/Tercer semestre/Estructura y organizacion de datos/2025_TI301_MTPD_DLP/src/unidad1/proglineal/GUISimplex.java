...
public class GUISimplex extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Interfaz Grafica de Metodo Simplex");
        ...
        jButton1.setText("Cambiar tamaño");
        ...
        jButton3.setText("Ejecutar el codigo");
        ...
        jButton2.setText("Guardar datos de la tabla");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        this.matrizD = new double[filas][columnas];
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for (int i = 0; i < filas; i++) {
            for (int j = 0; j < columnas; j++) {
                String valorCelda = String.valueOf(modelo.getValueAt(i, j));

                matrizD[i][j] = Double.parseDouble(valorCelda);
            }
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        Simplex simplex = new Simplex(matrizD);

        String matrizInicial = simplex.print();
        simplex.resolver();
        String matrizFinal = simplex.print();

        String resTotal = "Matriz del Problema\n"
                + matrizInicial
                + "\n\n"
                + "Matriz Final\n"
                + matrizFinal;

        JOptionPane.showMessageDialog(this, resTotal);
